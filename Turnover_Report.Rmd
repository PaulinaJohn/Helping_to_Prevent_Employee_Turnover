...
There doesn't seem to be much happening here. nearly all the relationships are weak; either weak positive or weak negative correlation.

However, a highlight here is how salary show little to no correlation with any of the other variables. This could mean that working more hours, taking up more projects, pulling a high score in the most recent evaluation exercise, recording a high satisfaction level, or spending more years at the company does not necessarily translate into a higher salary.
...
Hmmn! Looks like, on average, those employees who left work more hours than their counterparts who remained at the company.
...
I proceeded to look the data separately, for employees who have left and those who haven't, and to answer Tracy's second question.
