...
-   Satisfaction level at this company is 0.61 on average, out of a possible 1.0.
...
-   Employees spend at least, 2 years in the company and 3 years on average. However, there are employees that have stuck with the company for as many as 10 years.
...
-   Satisfaction level, last evaluation, Average monthly hours show a near balanced presence of all datapoints in these column and, infact, the avarge_monthly_hours column could pass for a normal distribution.
...
Let's now answer Tracy's questions and look at other insights obtainable from the dataset.
