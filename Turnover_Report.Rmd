...
However, a highlight here is how salary shows little to no correlation with any of the other variables. This could mean that working more hours, taking up more projects, pulling a high score in the most recent evaluation exercise, or remaining with the company for longer, does not necessarily attract a raise or a higher salary.
