...
Following my **Detect-Expose-Fix** model, I want to get distinct values of entries in columns with categorical data. This will help bring incorrectly entered or mis-spelled values to the fore. The columns are the
