...
have, at least, nearly the same number of employees or if some departments have more man power than others

. That way, you can look at proportion: count of left for each department / count of total number of employees in each department. Then when you now get to question 3, you can now use department too in your dicing and slicing.
